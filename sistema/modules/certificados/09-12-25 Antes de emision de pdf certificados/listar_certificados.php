...
if (empty($filas)) {
    ...
    foreach ($filas as $r) {
        ...
        // Botón 2: PDF (abre el certificado en una nueva pestaña)
        ...
        // Botón 4: eliminar (aún sin lógica)
        $tbodyHtml .= '<button type="button" class="btn-icon btn-icon-del" data-cert-id="' . $id . '"><i class="fas fa-trash-alt"></i></button>';
        $tbodyHtml .= '</td>';
        $tbodyHtml .= '</tr>';
    }
}
