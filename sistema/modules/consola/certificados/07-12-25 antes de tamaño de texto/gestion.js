...
export function init(slot, apiUrl) {
  ...
  // ---------- Panel 3: Elementos de certificado ----------
    ...
    // Prefijar ejemplos desde layout o valores por defecto
  ...
  const PV = {
    ...
    elements: {},                 // posiciones y ejemplos de textos
    activeElement: ''             // código del elemento actualmente seleccionado
  };
  ...
  slot.addEventListener('click', async e=>{
    ...
    tbody.querySelectorAll('tr').forEach(tr => {
      ...
      const base = PV.elements[code] || { x:50, y:50, w:40, texto };
      result[code] = {
