...
?>
<link rel="stylesheet" href="<?= BASE_URL ?>/modules/inventario/inventario.css?v=3">
        ...
        <div class="d-flex align-items-start justify-content-between flex-wrap">
          <div class="pr-2">
            <div class="invx-title">
              <span class="invx-badge"><i class="fas fa-sparkles"></i></span>
              Inventario General
            </div>
            <div class="invx-sub">
        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-12 col-lg-4 mb-2">
              <div class="input-group invx-search">
                ...
                <input id="q" class="form-control" placeholder="Buscar: nombre, marca, modelo, serie o código INV-...">
                <div class="input-group-append">
                  <button class="btn btn-outline-secondary" id="btnClear" title="Limpiar">
          ...
          <div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
            <div class="d-flex align-items-center flex-wrap">
              <div class="mr-2 mb-2">
                <button class="btn btn-outline-primary btn-sm" id="btnCats">
                  <i class="fas fa-tags mr-1"></i> Categorías
                </button>
                <span class="invx-chip ml-2 mb-2" id="catsChip">Todas</span>
              </div>
        ...
        <form id="frmBien" autocomplete="off">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-12 col-md-6">
              ...
              <small class="text-muted">Tip: podrás crear ubicaciones luego.</small>
            </div>
          </div>
          ...
          <div class="form-group mt-3">
            ...
            <div id="bienCats" class="invx-cats"></div>
          </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content invx-modal">
      ...
      <div class="modal-body text-center">
        ...
        <img id="qrImg" alt="QR" class="img-fluid invx-qrimg" src="">
        <div class="mt-2">
          <a id="qrDl" class="btn btn-invx btn-invx-primary btn-sm" href="#">
            <i class="fas fa-download mr-1"></i> Descargar PNG
          </a>
          <a id="qrOpen" class="btn btn-outline-secondary btn-sm" href="#" target="_blank">
            <i class="fas fa-external-link-alt mr-1"></i> Abrir detalle
          </a>
        </div>
        <div class="text-muted small mt-2">El QR se genera al vuelo (no se guarda imagen).</div>
      </div>
    </div>
  </div>
</div>
...
<script src="<?= BASE_URL ?>/modules/inventario/inventario.js?v=3"></script>
