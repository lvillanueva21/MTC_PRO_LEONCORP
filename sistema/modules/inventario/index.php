...
<div class="form-group">
  ...
  <div class="d-flex flex-wrap" style="gap:8px;">
    <button type="button" class="btn btn-outline-secondary btn-sm" id="btnImgPick">
      <i class="far fa-images mr-1"></i> Elegir de galería
    </button>
    <button type="button" class="btn btn-outline-secondary btn-sm" id="btnImgCam">
      <i class="fas fa-camera mr-1"></i> Tomar foto
    </button>
  </div>

  <!-- Input galería -->
  <input class="form-control mt-2 d-none" type="file" id="bienImgFile" accept="image/*">

  <!-- Input cámara (oculto) -->
  <input class="form-control mt-2 d-none" type="file" id="bienImgCamFile" accept="image/*" capture="environment">
